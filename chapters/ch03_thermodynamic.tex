...
\begin{intuition}
    ...
    The degeneracy factor $g$ states how many particles can stay in the same energy level, which is determined by the intrinsic spin quantum number $s$ of the particle. 
    On the other hand, it can be treat as the degree of freedom of the particle, which is the number of independent ways the particle can exist in a given energy state.
\end{intuition}
...
\begin{theory}
\begin{equation}
\frac{n_{i+1} n_e}{n_i} = \frac{2}{\lambda_e^3} \frac{g_{i+1}}{g_i} e^{-E_i/k_B T},
\end{equation}
where $\lambda_e = \sqrt{\frac{h^2}{2\pi m_e k_B T}}$ is the thermal de Broglie wavelength of the electron, $g_i$ and $g_{i+1}$ are the statistical weights of the ionization states, and $E_i$ is the ionization energy.
\end{theory}
