...
\end{enumerate}
\subsubsection*{Solution 4.2: Triple alpha process}
...
\begin{enumerate}[label=(\alph*)]
    \item $^4\text{He} + ^4\text{He} \to ^8\text{Be}$ (energy absorbed)
    \item $^8\text{Be} + ^4\text{He} \to ^{12}\text{C}^*$ (energy absorbed)
    \item $^{12}\text{C}^* \to ^{12}\text{C} + \gamma$ (energy released)    
\end{enumerate}

\subsubsection*{Solution 4.3: Temperature dependence of the CN cycle}
